...
import edu.fzu.tmall.util.DaoUtil;
...
public abstract class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public <T> List<T> findAll() {
        System.out.println("from " + clazz.getSimpleName() + " obj");
    ...
    public <T> List<T> findAllIterator() {
        int length = Integer.parseInt(this.findAllCount().toString());
    ...
    public <T> List<T> findByProperty(final T object, final Integer startRow, final Integer pageSize,
        ...
        try {
            ...
            stringBuffer.append("order by obj.").append(sortColumn).append(" ").append(desc);
            // 填充参数值
            Query query = DaoUtil.fillValues(sessionFactory, stringBuffer, propertyNames, values);
            // 返回链表
            list = query.list();
     ...
     *
     * @param HQL      HQL语句，如：select new Map(d.code as code, d.value as value) from
